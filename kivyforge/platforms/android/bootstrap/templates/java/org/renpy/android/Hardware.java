/*
 * org.renpy.android.Hardware — Kivy-compatibility shim.
 *
 * Kivy's own kivy/metrics.py calls autoclass('org.renpy.android.Hardware')
 * for DPI/fontscale, so the kivyforge bootstrap must supply this class for
 * unmodified Kivy-Android apps to start (android/05 §namespace preservation).
 * Vendored verbatim from python-for-android (MIT License,
 * https://github.com/kivy/python-for-android) — the surface Kivy was written
