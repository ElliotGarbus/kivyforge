...
| `pylock.macos.toml` | Pinned CPython 3.13 (PBS) + Kivy 2.3.1 universal2 wheel; gitignored, generated by `kivyforge lock -p macos` |
| `pylock.linux.toml` | Pinned CPython 3.13 (PBS gnu) + Kivy 2.3.1 manylinux wheel; gitignored, generated by `kivyforge lock -p linux` |
| `src/main.py` | The app |
