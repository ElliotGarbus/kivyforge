...
# Runtime window/Dock icon: reuse the bundled app-icon source (also used for the
# installed .icns / iOS icon via [tool.kivy.*.icons]).
_ICON = os.path.join(ASSETS, "compass.png")
